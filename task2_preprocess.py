...
if __name__ == "__main__":
    ...
    input_folders = [
        "data/train1/A/male",
        "data/train1/A/female",
        "data/train1/G/male",
        "data/train1/G/female",
        "data/train2/covid/male",
        "data/train2/covid/female",
        "data/train2/normal/male",
        "data/train2/normal/female",

        "data/Validation/val/A/male",
        "data/Validation/val/A/female",
        "data/Validation/val/G/male",
        "data/Validation/val/G/female",
        "data/Validation/val/covid/male",
    ...
    output_folders = [
        "data/train1/A_npy/male",
        "data/train1/A_npy/female",
        "data/train1/G_npy/male",
        "data/train1/G_npy/female",
        "data/train2/covid_npy/male",
        "data/train2/covid_npy/female",
        "data/train2/normal_npy/male",
        "data/train2/normal_npy/female",

        "data/Validation/val/A_npy/male",
        "data/Validation/val/A_npy/female",
        "data/Validation/val/G_npy/male",
        "data/Validation/val/G_npy/female",
        "data/Validation/val/covid_npy/male",
